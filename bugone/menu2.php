                ...
                <tbody>
                    ...
                    if (!empty($products)) {
                        foreach ($products as $product) {
                            ...
                            echo "<td><button class='btn btn-danger' data-toggle='modal' data-target='#confirmDeleteModal' data-productid='" . $product['ID'] . "'><i class='fas fa-trash'></i> Delete</button></td>";
                            echo "</tr>";
                        }
                    } else {
